...
A bloat guard skill for codebases that are still growing — **executable detectors, not principles**. 防膨胀技能 / 反屎山 / 代码清理 / 技术债务检测
...
**OpenCode (other code agents can reference this)**
